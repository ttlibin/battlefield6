    ...
    async loadTranslations() {
        this.translations = {
            'zh-CN': {
                ...
                // 视频区
                'video.title': '官方预告片',
                'video.gameTitle': 'BATTLEFIELD 6',
                'video.gameSubtitle': '战地风云6',
                'video.gameTagline': '次世代全面战争体验，128人大规模战场',
                'video.shortDescription': '见证全球领先的私人军事公司"和平军团"开辟的恶性破坏之路。子弹上膛，获得终极全面战争体验。投入高强度步兵作战，在近距离空战中划破天空。',
                'video.description': '见证全球领先的私人军事公司"和平军团"开辟的恶性破坏之路。和平军团力求摧毁北约及其盟国，不惜一切代价捍卫他们的座右铭："我们的保护，你们的和平。"',
                'video.description2': '子弹上膛，获得终极全面战争体验。投入高强度步兵作战。在近距离空战中划破天空。摧毁周围环境，赢得战略优势。在坦克、战斗机和大量武器的战争中，你的小队是最致命的武器。这就是《战地风云 6》。',
                'video.watchOnYouTube': '在YouTube上观看',
                'video.moreVideos': '更多视频',
                'video.combatClasses': '战斗系统与职业',
                'video.multiplayer': '多人对战',
            ...
            'en-US': {
                ...
                'video.gameTitle': 'BATTLEFIELD 6',
                'video.gameSubtitle': 'Battlefield 6',
                'video.gameTagline': 'Next-gen all-out warfare experience, 128-player massive battles',
                'video.shortDescription': 'Witness the path of malicious destruction paved by the world\'s leading private military company "Peace Corps". Lock and load for the ultimate all-out warfare experience. Engage in high-intensity infantry combat and tear through the skies in close-quarters aerial combat.',
                'video.description': 'Witness the path of malicious destruction paved by the world\'s leading private military company "Peace Corps". The Peace Corps seeks to destroy NATO and its allies, defending their motto at all costs: "Our protection, your peace."',
                'video.description2': 'Lock and load for the ultimate all-out warfare experience. Engage in high-intensity infantry combat. Tear through the skies in close-quarters aerial combat. Destroy the environment around you to gain strategic advantages. In wars of tanks, fighter jets, and massive weapons, your squad is the deadliest weapon. This is Battlefield 6.',
                'video.watchOnYouTube': 'Watch on YouTube',
                'video.moreVideos': 'More Videos',
                'video.combatClasses': 'Combat, Classes & Destruction',
                'video.multiplayer': 'Multiplayer Gameplay',
            ...
            'de-DE': {
                ...
                // Video
                'video.title': 'Offizieller Trailer',
                'video.gameTitle': 'BATTLEFIELD 6',
                'video.gameSubtitle': 'Battlefield 6',
                'video.gameTagline': 'Next-Gen All-out-Warfare-Erlebnis, 128-Spieler-Massenschlachten',
                'video.shortDescription': 'Erleben Sie den Weg der bösartigen Zerstörung, den die weltweit führende private Militärfirma "Friedenskorps" geebnet hat. Laden und sichern für das ultimative All-out-Warfare-Erlebnis. Engagieren Sie sich in hochintensiven Infanteriekämpfen und reißen Sie durch die Lüfte in Nahkampf-Luftschlachten.',
                'video.description': 'Erleben Sie den Weg der bösartigen Zerstörung, den die weltweit führende private Militärfirma "Friedenskorps" geebnet hat. Das Friedenskorps sucht NATO und ihre Verbündeten zu zerstören und verteidigt ihr Motto um jeden Preis: "Unser Schutz, euer Frieden."',
                'video.description2': 'Laden und sichern für das ultimative All-out-Warfare-Erlebnis. Engagieren Sie sich in hochintensiven Infanteriekämpfen. Reißen Sie durch die Lüfte in Nahkampf-Luftschlachten. Zerstören Sie die Umgebung um Sie herum, um strategische Vorteile zu gewinnen. In Kriegen von Panzern, Kampfflugzeugen und massiven Waffen ist Ihr Trupp die tödlichste Waffe. Das ist Battlefield 6.',
                'video.watchOnYouTube': 'Auf YouTube ansehen',
                'video.moreVideos': 'Weitere Videos',
                'video.combatClasses': 'Kampf, Klassen & Zerstörung',
                'video.multiplayer': 'Multiplayer-Gameplay',
            ...
            'ja-JP': {
                ...
                'video.title': '公式トレーラー',
                'video.gameTitle': 'BATTLEFIELD 6',
                'video.gameSubtitle': 'バトルフィールド 6',
                'video.gameTagline': '次世代全面戦争体験、128人大規模戦闘',
                'video.shortDescription': '世界をリードする民間軍事会社「ピース・コープス」が切り開いた悪意ある破壊の道を目撃せよ。弾薬を装填し、究極の全面戦争体験を手に入れろ。高強度の歩兵戦闘に参加し、近距離空中戦で空を切り裂け。',
                'video.description': '世界をリードする民間軍事会社「ピース・コープス」が切り開いた悪意ある破壊の道を目撃せよ。ピース・コープスはNATOとその同盟国を破壊し、彼らのモットー「我々の保護、あなたの平和」をあらゆる代償を払って守ろうとする。',
                'video.description2': '弾薬を装填し、究極の全面戦争体験を手に入れろ。高強度の歩兵戦闘に参加せよ。近距離空中戦で空を切り裂け。戦略的優位を得るために周囲の環境を破壊せよ。戦車、戦闘機、大量の武器の戦争において、あなたの分隊が最も致命的な武器だ。これがBattlefield 6である。',
                'video.watchOnYouTube': 'YouTubeで視聴',
                'video.moreVideos': 'その他の動画',
                'video.combatClasses': '戦闘システムとクラス',
                'video.multiplayer': 'マルチプレイヤー',
            ...
            'ko-KR': {
                ...
                'video.title': '공식 트레일러',
                'video.gameTitle': 'BATTLEFIELD 6',
                'video.gameSubtitle': '배틀필드 6',
                'video.gameTagline': '차세대 전면전 경험, 128명 대규모 전투',
                'video.shortDescription': '세계 최고의 민간 군사 회사 "피스 코프스"가 개척한 악의적인 파괴의 길을 목격하라. 탄약을 장전하고 궁극의 전면전 경험을 얻어라. 고강도 보병 전투에 참여하고 근거리 공중전에서 하늘을 가르라.',
                'video.description': '세계 최고의 민간 군사 회사 "피스 코프스"가 개척한 악의적인 파괴의 길을 목격하라. 피스 코프스는 NATO와 그 동맹국들을 파괴하려 하며, 그들의 모토 "우리의 보호, 당신의 평화"를 어떤 대가를 치르더라도 지키려 한다.',
                'video.description2': '탄약을 장전하고 궁극의 전면전 경험을 얻어라. 고강도 보병 전투에 참여하라. 근거리 공중전에서 하늘을 가르라. 전략적 우위를 얻기 위해 주변 환경을 파괴하라. 탱크, 전투기, 대량의 무기들의 전쟁에서 당신의 분대가 가장 치명적인 무기다. 이것이 Battlefield 6이다.',
                'video.watchOnYouTube': 'YouTube에서 시청',
                'video.moreVideos': '더 많은 비디오',
                'video.combatClasses': '전투 시스템과 클래스',
                'video.multiplayer': '멀티플레이어',
